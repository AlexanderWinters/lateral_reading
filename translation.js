const languageData = {
  en: {
    ...
    aiSummary_6: "Reports of the celebrity's death are <span>false</span>. The celebrity's official representatives have confirmed they are alive and well. The post originated from a known 'death hoax' website designed to generate <span>ad revenue</span> through viral misinformation.",
...
// Weather Alert Post (Post 7)
    ...
    sv: {
        ...
        aiSummary_6: "Rapporter om kändisens död är <span>falska</span>. Kändisens officiella representanter har bekräftat att de lever och mår bra. Inlägget härstammar från en känd webbplats för 'dödsbluffar' som är utformad för att generera <span>annonsintäkter</span> genom viral desinformation.",
