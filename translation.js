const languageData = {
  en: {
    ...
    aiSummary_2: "Reports of an immediate threat to the library are <span>unsubstantiated</span>. Local law enforcement has issued no alerts, and the library remains open with no security incidents. The vague nature of the 'threat' and the use of inflammatory language suggest this is a <span>hoax</span> aimed at creating public anxiety.",
...
// Weather Alert Post (Post 7)
    ...
    sv: {
        ...
        aiSummary_2: "Rapporter om ett omedelbart hot mot biblioteket är <span>obekräftade</span>. Lokal polis har inte utfärdat några larm, och biblioteket förblir öppet utan säkerhetsincidenter. Det vaga innehållet i 'hotet' och användningen av inflammatoriskt språk tyder på att detta är en <span>bluff</span> som syftar till att skapa oro hos allmänheten.",
